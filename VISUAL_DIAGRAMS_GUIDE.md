...
### **Method 1: In GitHub (Best)**
1. Copy any Mermaid code block above
2. Paste in GitHub markdown files
3. Renders automatically! ✓

### **Method 2: In Your Report**
1. Copy the code block
2. Paste in Markdown editor (Notion, Obsidian, etc.)
3. Most will render automatically

### **Method 3: Convert to Image**
1. Go to: https://mermaid.live/
2. Paste the Mermaid code
3. Download as PNG/SVG
4. Use in Word, PowerPoint, or PDF

### **Method 4: Export as High-Quality Images**
1. Go to: https://kroki.io/
2. Paste Mermaid code
3. Download as PNG/SVG/PDF
4. Embed in report
...
| Tool | URL | Features |
|------|-----|----------|
| **Mermaid Live** | https://mermaid.live/ | Real-time preview, export PNG/SVG |
| **Draw.io** | https://draw.io/ | Drag-drop diagram builder |
