const LoadingSpinner = () => {
    return (
        <div className="h-screen w-full flex flex-col gap-8 absolute z-50 inset-0 items-center justify-center bg-black shadow-[0_0_10px_cyan]">
            <div className="h-32 w-32 flex items-center justify-center animate-bounce bg-transparent border-4 border-cyan-500 ">
