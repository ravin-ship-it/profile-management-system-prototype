    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen w-full bg-gray-900" style={{ background: `linear-gradient(180deg, rgba(0,0,0,0), rgba(0,0,0,1)), url(${landingBg}) no-repeat center / cover fixed` }}>
            ...
            <div className="flex gap-8">
                <Link to="/create" className="mt-16 mb-4 text-2xl px-8 py-4 font-semibold capitalize rounded-full text-white bg-blue-600 hover:bg-pink-600 hover:-translate-y-1 transition-all duration-300 ease-in-out">get started</Link >
                <Link to="/profiles" className="mt-16 mb-4 text-2xl px-8 py-4 font-semibold capitalize rounded-full bg-white hover:bg-pink-600 hover:text-white hover:-translate-y-1 transition-all duration-300 ease-in-out">view profiles</Link >
            </div>
        </div >
    )
